...
def day_042():
	...
	try:
		...
		webbrowser.get(chrome_path).open(f'file://{this_directory}/tools/days/day_042/files/index.html')
	except:
		try:
			webbrowser.get().open('file://d:/dev/Python100/tools/days/day_042/files/index.html')
		except:
