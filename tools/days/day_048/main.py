...
def day_048():
	...
	go = True
	unlocked_store_items = driver.find_elements_by_css_selector("div[class='product unlocked enabled']")
	upgrades = driver.find_elements_by_css_selector("div[class='crate upgrade enabled']")
